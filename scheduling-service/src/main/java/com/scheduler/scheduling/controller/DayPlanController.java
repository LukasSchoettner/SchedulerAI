...
public class DayPlanController {
    ...
    public ResponseEntity<DayPlanResponse> generate(
        ...
        return ResponseEntity.ok(dayPlanService.generatePlan(extractCustomerId(authHeader), date != null ? date : LocalDate.now()));
    }
    ...
    public ResponseEntity<DayPlanResponse> regenerate(
        ...
        return ResponseEntity.ok(dayPlanService.regenerate(extractCustomerId(authHeader), id));
    }
